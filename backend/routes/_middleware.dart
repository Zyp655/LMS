...
import 'package:backend/middleware/cache_headers_middleware.dart';
import 'package:backend/middleware/cors_middleware.dart';
import 'package:backend/middleware/error_handler_middleware.dart';
import 'package:backend/middleware/gzip_middleware.dart';
...
final _redis = RedisService()..connect();
...
Handler middleware(Handler handler) {
  return handler
      ...
      .use(provider<RedisService>((_) => _redis))
